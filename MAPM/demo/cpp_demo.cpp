...
/*
 *  check MAPM version info from mapm/m_apm.h to what was compiled into
 *  the library. This check could be used in your application to
 *  confirm that you are using the correct include file (mapm/m_apm.h).
 */
...
{
	char fBuf[256];
	MAPM m = MAPM(x, 14);   // MAPM now "too" accurate
